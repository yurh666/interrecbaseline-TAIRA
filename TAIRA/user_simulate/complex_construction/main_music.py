...
from complex_query.history_extractor import HistoryExtractor
...
def main():
    # 读取文件
    input_file = '../dataset/music/merged_metadata.csv'
    output_file = '../dataset/music/query_music.csv'
    knowledge_file = '../knowledge/updated_music_knowledge0.csv'
    user_interaction_file = '../dataset/music/user_profile.csv'
    ...
    for _, user_row in user_interaction_df.iterrows():
        ...
        if random.random() < 1/3:
            ...
            purpose = searcher_agent.music_search_knowledge(category, knowledge_file)  # 用途
            print(purpose)
            while query is None or query == '':
