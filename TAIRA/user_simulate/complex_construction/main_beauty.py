...
def main():
    # 读取文件
    input_file = '../dataset/beauty/merged_metadata.csv'
    output_file = '../dataset/beauty/query_beauty.csv'
    knowledge_file = '../knowledge/beauty_knowledge0.csv'
    user_interaction_file = '../dataset/beauty/user_profile.csv'
