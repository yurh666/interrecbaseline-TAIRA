...
# 读取CSV文件
df = pd.read_csv('../dataset/cloth/metadata0.csv')
# df = df.head(5000)
...
# 输出分类短语的总数
print(f"服装数据集总共有 {len(unique_categories_list)} 个分类短语")
...
# # answer = searcher.google_search("Who is the US president?", 1)
# # print(answer)
#
# data = []
#
...
# df.to_csv('../knowledge/knowledge0.csv', index=False)
